...
const MyBookings = () => {
   ...
   return (
      <div className="py-28 md:pb-35 md:pt-24 px-4 md:px-16 lg:px-24 xl:px-32">
         <Title title="My Bookings" subTitle='Easily manage your past, current and upcoming reservations in one place. Plan your stays with confidence and convenience.' align='left'/>
