...
const DashBoard = () => {
  ...
  return (
    <div>
      <Title align='left' font='outfit' title='Dashboard' subTitle='Monitor your room listing and analyze revenue-all in one place. Stay updated with real-time insights and performance metrics.' />
            ...
            <tbody className='text-sm'>
               {dashboardData.bookings.map((item, index)=>(
                  <tr key={index}>
                     ...
                     <td className='py-3 px-4 text-gray-700 max-sm:hidden border-t border-gray-300'>{item.room.roomType}</td>
